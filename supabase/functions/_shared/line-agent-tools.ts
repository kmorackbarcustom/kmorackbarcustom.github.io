...
export const LINE_AGENT_TOOLS: ToolDef[] = [
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "เช็คสถานะงานจองคิว/ออเดอร์สั่งผลิตของลูกค้าในระบบ เรียกเมื่อลูกค้าถามว่างานของตัวเองถึงไหนแล้ว/เสร็จยัง ระบบรู้ตัวตนลูกค้าจาก LINE อยู่แล้ว ไม่ต้องมี phone ก็เรียกได้ ใส่ phone เฉพาะตอนที่ลูกค้าพิมพ์เบอร์มาในแชท",
      parameters: {
        type: "object",
