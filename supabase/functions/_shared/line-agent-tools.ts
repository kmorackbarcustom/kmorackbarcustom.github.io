...
function formatProducts(products: MatchedProduct[]): string {
  if (products.length === 0) {
    return "ไม่พบสินค้าที่ตรงกับคำค้นนี้ในระบบ ถ้าลูกค้ายังไม่ได้บอกชัดว่าต้องการรุ่นรถ/ชิ้นส่วนอะไร ให้ถามกลับก่อน ห้ามเดาลิงก์เอง " +
      "แต่ถ้าลูกค้าบอกรุ่นรถและชิ้นส่วนที่ต้องการมาแล้วชัดเจน (แม้ระบบไม่มีข้อมูลราคารุ่นนี้) ให้ส่งลิงก์ที่ตรงกับงานทันที " +
      "(งานที่ต้องเอารถเข้าร้าน -> ลิงก์จองคิว, สั่งผลิต/สั่งซื้อได้เลยไม่ต้องเข้าร้าน -> ลิงก์สั่งผลิต) พร้อมบอกว่าราคาให้ทีมงานยืนยันอีกที " +
      "ห้ามใช้ 'ไม่มีข้อมูลในระบบ' เป็นเหตุผลไม่ส่งลิงก์";
  }
